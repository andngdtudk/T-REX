mdp_configs = {
    ...
    'IDQN_MM2': {
        'kbh_j1_442m': {
            'car_wait_weight': 1.0,
            'bike_wait_weight': 0.8228, # was 1, then kept 1, was 74% of bike signal, then 0.3225 but still too much. 0.7683 was nice
            'ped_wait_weight': 250.4704, # was 1, was only .9% of reward signal, then 6.6864, then 99.7661, 114.603 was nice
            'norm_wait': 481.5, # was 224, 443.1 after mm but with new weights needs to be higher 1717.5, then 1413.5, with collisions solver, 540.5 nice
            'clip_wait': 3.0,
        },
        'kbh_j9_442m': {
            'car_wait_weight': 1.0,
